...
# (165,11)
co_raw <- fread("data/year1/csv/7-Colorado_AppendixB.csv",
                      colClasses = "character", na.strings = "") %>%
  clean_names()
...
## PPL
# (60,18)
in_ppl <- fread("data/year1/csv/14-Indiana_IUP_PPL.csv",
                      colClasses = "character", na.strings = "") %>%
  clean_names()

## Lead
# (8,17)
in_lead_q123 <- fread("data/year1/csv/14-Indiana_PPL_Lead(Q1 2023).csv",
                 colClasses = "character", na.strings = "") %>%
  clean_names()
...
```{r}
# (172, 16)
nv_raw <- fread("data/year1/csv/28-Nevada_PPL.csv",

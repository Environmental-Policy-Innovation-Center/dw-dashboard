...
dc_clean <- dc_ppl %>%
  ...
  project_cost = as.numeric(str_replace_all(grant_funding,"[^0-9.]","")),
  state = "District of Columbia",
  project_type = "Other",
  fundable = "Applicant"
  ) %>%
  select(project_name, project_cost, project_type, state, fundable)
...
web_combined_clean_test <- combined_test %>%
                          ...
                          select(state, cities_served, borrower,
                                 ...
                                 project_cost, requested_amount, fundable) %>%
                          rename(State = state,
                                Borrower = borrower, 

...
Details for necessary transformations, crucial context, and discussion on decisions and assumptions can be found in each state's Background Information PDFs, available as a data download through the SRF Dashboard or on Google Drive.
...
al_app_clean <- al_applicant %>%
  ...
  select(borrower, cities_served, project_description, requested_amount, funding_amount,
         principal_forgiveness_amount, state, funding_status)
...
## Combined all Funded projects into one file
# -> (29,14)
...
al_clean <- al_comb %>%
  ...
  select(state_score, borrower, pwsid, project_name, project_description, funding_amount, principal_forgiveness_amount, 
         ...
         #requested_amount, 
         population, cities_served, disadvantaged, project_type, funding_status, state)
...
ar_app <- ar_comp %>%
  ...
  select(borrower, pwsid, project_description, project_type,
         ...
         disadvantaged, population, funding_status, state)
...
ar_fund <- ar_merge %>% 
  ...
  select(state_rank, state_score, borrower, pwsid, project_description, 
         funding_amount, principal_forgiveness_amount, population, disadvantaged, project_type, funding_status, state)
...
ca_fund <- fread("data/year1/csv/5-California_Fundable_PPL.csv",
  ...
  select(borrower, pwsid, project_name, project_description, funding_amount, principal_forgiveness_amount, 
         project_type, project_cost, population, state, funding_status)
...
ca_ec <- fread("data/year1/csv/5-California_EC.csv",
  ...
  mutate(pwsid = paste0("CA", as.character(map(strsplit(project_number, split = "-"), 1))),
         ...
         funding_status = "Funded") %>%
  select(borrower, pwsid, project_name, project_description, funding_amount, principal_forgiveness_amount, 
         project_type, population, disadvantaged, state, funding_status)
...
ca_app <- fread("data/year1/csv/5-California_Comprehensive_PPL.csv",
  ...
  select(borrower, project_name, project_description, project_type, project_cost, population, 
         disadvantaged, state, funding_status)
...
co_b_clean <- co_b %>%
  ...
  select(borrower, pwsid, project_name, project_description, state_score, project_cost,
         funding_amount, population, cities_served, disadvantaged, project_type, state, funding_status) %>%
  distinct()
...
co_b1_clean <- co_b1 %>%
  ...
  select(state_score, borrower, pwsid, project_name, project_description, project_cost,
         funding_amount, project_type, cities_served, population, disadvantaged, state, funding_status)
...
dc_clean <- dc_ppl %>%
  ...
  select(project_description, funding_amount, project_type, state, funding_status)
...
fl_fund <- fread("data/year1/csv/9-Florida_ppl_fundable.csv",
  ...
  select(borrower, project_name, project_description, state_score, funding_amount, 
         principal_forgiveness_amount, project_type, state, funding_status)
...
ga_base <- ga_raw %>%
  ...
  select(state_score, borrower, project_description, funding_amount, project_cost,
         population, disadvantaged, funding_status, project_type, state)
...
id_clean <- id_merged %>%
  ...
  select(state_rank, state_score, borrower, pwsid, project_description, population, project_cost,
         disadvantaged, funding_amount, funding_status, principal_forgiveness_amount, project_type, state)
...
il_clean <- il_merge %>%
  ...
  # keep relevant columns
  select(state_score, borrower, pwsid, project_description, population, disadvantaged, funding_amount, principal_forgiveness_amount, project_type, funding_status, state)
...
in_clean <- in_comb %>%  
  ...
  select(borrower, pwsid, state_rank, state_score, project_name, project_description,
         project_type, requested_amount, population, disadvantaged, project_type, state, funding_status)
...
ks_clean <- ks_comb %>%
  ...
  select(borrower, state_score, project_name, project_description, requested_amount,
         population, project_type, state, funding_status)
...
la_clean <- la_comb %>%
  ...
  select(state_rank, state_score, borrower, pwsid, project_description, funding_amount, principal_forgiveness_amount, population, disadvantaged, project_type, funding_status, state)
...
me_comp <- fread("data/year1/csv/19-Maine_PPL_Comprehensive.csv",
  ...
  select(borrower, pwsid, state_score, project_name,  project_description, funding_amount, 
         principal_forgiveness_amount,  disadvantaged, project_type, population, state, funding_status)
...
md_clean <- md_raw %>%
  ...
  select(state_rank, state_score, borrower, pwsid, project_name, project_description, funding_amount,
         principal_forgiveness_amount, cities_served, population, disadvantaged, funding_status, project_type, state)
...
mn_clean <- mn_raw %>%
  ...
  select(state_rank, state_score, borrower, pwsid, project_description, population, disadvantaged,
         funding_amount, principal_forgiveness_amount, funding_status, project_type, state)
...
ms_clean <- ms_raw %>%
  ...
  select(borrower, project_description, state_score, funding_amount, principal_forgiveness_amount,
         state, project_type, funding_status)
...
mo_clean <- mo_comb %>%
  ...
  select(state_score, borrower, project_description, population, funding_amount,
         principal_forgiveness_amount, disadvantaged, funding_status, state, project_type)
...
mt_clean <- mt_raw %>%
  ...
  select(state_rank, borrower, project_description, funding_amount, 
         principal_forgiveness_amount, population, project_type, funding_status, state)
...
ne_clean <- ne_merged %>%
  ...
  select(borrower, pwsid, state_score, project_description, funding_amount, principal_forgiveness_amount, project_type,
         disadvantaged, funding_status, state)
...
nh_clean <- nh_raw %>%
  ...
  select(borrower, pwsid, cities_served, project_name, project_type, state_rank, state_score,
         funding_amount, principal_forgiveness_amount, disadvantaged, population, funding_status, state)
...
nj_clean <- nj_raw %>%
  ...
  select(borrower, pwsid, state_rank, state_score, project_name, project_description, project_cost, 
         population, state, funding_status)
...
nm_clean <- nm_raw %>%
  ...
  select(state_rank, state_score, borrower, pwsid, project_description, funding_amount, principal_forgiveness_amount, disadvantaged, population, cities_served, project_type, funding_status, state)
...
ny_clean <- ny_comb %>%
  ...
  select(borrower, state_score, project_name, project_description, project_cost,
         population, cities_served, disadvantaged, project_type, state, funding_status)
...
nc_clean <- nc_raw %>%
  ...
  select(borrower, pwsid, project_name, state_score, funding_amount, principal_forgiveness_amount,
         cities_served, project_type, population, state, funding_status)
...
nd_clean <- nd_ppl %>%
  ...
  select(borrower, project_name, pwsid, project_type, project_description,
         state_rank, funding_amount, principal_forgiveness_amount, disadvantaged, population, funding_status, state)
...
oh_clean_2 <- oh_comb %>%
  ...
  select(borrower, pwsid, project_description, project_cost,
         cities_served, population, disadvantaged, state, project_type, funding_status) %>%
...
ok_clean <- ok_comb %>%
  ...
  select(borrower, state_score, project_name, project_description, requested_amount, funding_amount,
         disadvantaged, population, project_type, state, funding_status)
...
pa_clean <- pa_raw %>%
  ...
  select(borrower, pwsid, cities_served, project_name, project_description, project_type,
         state_rank, state_score, funding_amount, principal_forgiveness_amount, disadvantaged, population, funding_status, state)
```
...
sd_clean <- sd_merged %>%
  ...
  select(borrower, project_description, project_type, state_score, funding_amount, 
         principal_forgiveness_amount, population, disadvantaged, funding_status, state) 
```
...
tx_clean <- tx_merge %>%
  ...
  select(state_rank, state_score, borrower, pwsid, project_description, funding_amount, population, disadvantaged, funding_status, project_type, state)
```
...
vt_ppl <- vt_ppl %>%
  ...
  select(state_score, borrower, pwsid, project_description, population,
         funding_amount, principal_forgiveness_amount, project_type, funding_status, project_type, state)
...
vt_lead <- vt_lead %>%
  ...
  select(state_score, borrower, pwsid, funding_amount, principal_forgiveness_amount, population,
         disadvantaged, project_type, funding_status, state)
...
vt_ec <- vt_ec %>%
  ...
  select(state_score, borrower, pwsid, funding_amount, principal_forgiveness_amount,
         project_description, disadvantaged, population, project_type, funding_status, state)
...
wa_clean <- wa_merged %>%
  ...
  select(state_score, borrower, pwsid, project_name, project_description, cities_served, population, 
         funding_amount, principal_forgiveness_amount, funding_status, disadvantaged, project_type, state)
...
wv_clean <- wv_raw %>%
  ...
  select(borrower, project_name, project_description, project_type,
         ...
         disadvantaged, population, cities_served, funding_status, state)
```
...
web_combined_clean <- combined_clean %>%
                          ...
                          select(state, cities_served, borrower,
                                 ...
                                 population, disadvantaged, state_rank, state_score, funding_status) %>%
                          rename(State = state,
                                Borrower = borrower, 

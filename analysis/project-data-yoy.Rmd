...
dac_pc <- project_dollars |>
  dplyr::select(state_fiscal_year, project_cost_ndac, project_cost_dac, project_cost_dac_ni, project_cost_dac_na) |>
  tidyr::pivot_longer(cols = c("project_cost_ndac", "project_cost_dac", "project_cost_dac_ni", "project_cost_dac_na")) |>
  dplyr::group_by(state_fiscal_year, name) |>
  dplyr::summarize(value = sum(value, na.rm = TRUE), .groups = "drop") |>
  dplyr::group_by(state_fiscal_year) |>

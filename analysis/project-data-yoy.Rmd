...
dac_ef_hm_p <- ggplot(dac_ef_grid, aes(x=expecting_funding, y=dac, fill=value, text=value)) + 
...
dac_ef_hm_p_facet <- dac_ef_hm_p + facet_wrap(~state_fiscal_year)

ggplotly(dac_ef_hm_p_facet, tooltip="text") %>%

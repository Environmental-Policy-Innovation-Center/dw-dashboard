...
financial_in <- data.frame(read_sheet(URL, sheet="FinancialData"))

set_asides_allowances_in <- data.frame(read_sheet(URL, "SetAsides"))
...
set_asides_allowances <- set_asides_allowances_in %>%
  clean_names() %>%

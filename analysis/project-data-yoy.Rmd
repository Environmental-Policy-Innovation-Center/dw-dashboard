...
tra_gp
# if (save_plots) {
#save_to_aws(tra_gp, "total-requested-amount-yoy", state_abbr) }
}
...
if (save_plots) {
save_to_aws(tpc_gp, "total-project-cost-yoy", state_abbr) }
...
# if (save_plots) {
#save_to_aws(tfa_gp, "total-funding-amount-yoy", state_abbr) }
tfa_gp
}
```
...
# if (save_plots) {
#save_to_aws(tpf_gp, "total-pf-yoy", state_abbr) }
tpf_gp
}
```
...
if (save_plots) {
save_to_aws(efp_gp, "applicant-expected-funding-projects-yoy", state_abbr) }
...
if (save_plots) {
save_to_aws(dac_pct_gp, "percent-projects-serving-dacs", state_abbr) }
...
# if (save_plots) {
#save_to_aws(dac_pt_gp, "project-type-serving-dacs", state_abbr) }
...
if (save_plots) {
save_to_aws(ef_dac_gp, "dacs-projects-expecting-funding", state_abbr) } 
...
if (save_plots) {
save_to_aws(ef_dac_pct_gp, "percent-expecting-funding-serving-dacs", state_abbr) }
...
# if (save_plots) {
#save_to_aws(all_pt_gp, "applicant-projects-by-type", state_abbr) }
...
sc_pop_gp <- ggplotly(sc_pop_p, tooltip="text") %>%
  layout(title = list(text = paste0("How many projects serve small communities (<10k)?",
                                    '<br>',
                                    subtitle_str)))
...
sc_ef_gp <- ggplotly(sc_ef_p, tooltip="text") %>%
  layout(title = list(text = paste0("How many projects serving small communities (<10k) could expect funding?",
                                    '<br>',
                                    subtitle_str)))
...
if (save_plots) {
save_to_aws(tpc_pt_gp, "project-cost-by-type", state_abbr) }
tpc_pt_gp
}
```
...
# if (save_plots) {
#save_to_aws(tra_pt_gp, "requested-amount-by-project-type", state_abbr) }
tra_pt_gp
}
```
...
# if (save_plots) {
#save_to_aws(tfa_pt_gp, "funding-amount-by-project-type", state_abbr) }
tfa_pt_gp
}
```
...
# if (save_plots) {
#save_to_aws(tpf_pt_gp, "principal-forgiveness-by-project-type", state_abbr) }
tpf_pt_gp
}
```
...
if (save_plots) {
save_to_aws(avg_demand_gp, "average-median-demand", state_abbr) }
avg_demand_gp
}
```

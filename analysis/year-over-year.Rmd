...
ggplot(expecting_funding_projects, aes(x=state_fiscal_year, y=value, fill=expecting_funding)) + 
  ...
  labs(title="Proportion of Applicant Projects Expecting Funding",
       subtitle="State IUP/PPLs",
       x="State Fiscal Year",
       y="Projects") + 
  epic_chart_theme
...
ggplot(state_yoy, aes(x=state_fiscal_year, y=disadvantaged_percent)) + 
  geom_line(group=1, color="#172f60") + 
  geom_point(color="#172f60") + 
...
ggplot(ef_dac_projects, aes(x=state_fiscal_year, y=value, fill=expecting_funding)) + 
  ...
  labs(x="State Fiscal Year",
       y="Projects",
       title="How many Disadvantaged Community Projects Could Expect Funding?") + 
    scale_fill_manual(values = cat_palette(2), 
                      name = "Expecting Funding") + 
  epic_chart_theme
...
ggplot(sfy_project_cost, aes(x=state_fiscal_year, y=value, fill=name)) + 
  ...
  labs(x="State Fiscal Year",
       y="",
       title="Project Cost for All Applicants",
       subtitle=paste(state_name, " IUP/PPLs")) +
  epic_chart_theme
```

...
- Need to scrape additional data for Applicants. Scrape is a WIP due to formatting issues.
- Mentions *Interest Rates or Loan Terms*
...
- Applicant data is processed
- No mention of `requested_funds` or `loan_amount`
- No mention of *Interest Rates or Loan Terms*
...
- TODO: Applicant data
- No mention of `funding_requested` or `project_cost`
- No mention of *Interest Rates or Loan Terms*
...
- TODO: Applicant data needs to be processed
- No mention of `funding_requested` or `project_cost`
- No mention of *Interest Rates or Loan Terms*
...
- TODO: Applicant data is processed, but needs to be interpretted and assigned the variable

...
al_clean <- al_comb %>%
  ...
  select(state_score, borrower, pwsid, project_name, project_description, funding_amount, principal_forgiveness_amount, 
         ...
         #requested_amount, 
         population, cities_served, disadvantaged, project_type, funding_status, state, category)
...
md_clean <- md_raw %>%
  ...
  select(state_rank, state_score, borrower, pwsid, project_name, project_description, funding_amount,
         principal_forgiveness_amount, cities_served, population, disadvantaged, funding_status, project_type, state, category)
...
PPL_State_Data_Geo <- web_combined_clean %>%
...
## Note manually addition of states which have only applicant date

...
if( sum(set_asides_allowances_group$total_sa_amt_fcg, na.rm=TRUE) > 0 ) {
...
if (save_plots) {
  run_save_plots(gp_object = setasides_allowances_group_gp, # change
                 sub_folders, 
                 file_name = "set-asides-amount-by-allowance.html", # change
                 gs_tab) }

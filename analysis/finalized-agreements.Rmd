...
In the future, this notebook will need to be modified to either handle multiple years of data or be modified to work on only one year of data and then develop a second year-over-year notebook, similar to how the IUP data is handled.
...
ggplot(by_dac, aes(x=value, y=disadvantaged_assistance, fill=name)) + 
  ...
  labs(x="", y="Disadvantaged", fill="",
       title="Finalized Awards & Subsidy", subtitle = paste(state_name, "SFY23")) + 
  scale_fill_manual(values=c("#4ea324", "#1054a8")) +  

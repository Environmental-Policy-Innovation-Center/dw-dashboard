...
lsl_projects <- all_projects |>
  ...
  dplyr::mutate(
    lead_type_new = coalesce(lead_type_new_TX, lead_type_new_PA, lead_type_new_MD),
    lead_type = dplyr::if_else(lead_type == "both" & !is.na(lead_type_new), lead_type_new, lead_type)
    ) |>
    dplyr::select(-c(lead_type_new, lead_type_new_TX, lead_type_new_PA, lead_type_new_MD))

...
# Alabama
source("year0/AL/code/clean-AL.R")
al_clean_y0<- clean_al_y0()
...
# Louisiana
source("year0/LA/code/clean-LA.R")
la_clean_y0 <- clean_la_y0()
...
# New York 
source("year0/NY/code/clean-NY.R")
ny_clean_y0 <- clean_ny_y0()
...
# Alabama
source("year2/AL/code/clean-AL.R")
al_clean_y2 <- clean_al_y2()
...
# Louisiana
source("year2/LA/code/clean-LA.R")
la_clean_y2 <- clean_la_y2()
...
# Alabama
source("year3/AL/code/clean-AL.R")
al_clean_y3 <- clean_al_y3()

# Louisiana
source("year3/LA/code/clean-LA.R")
la_clean_y3 <- clean_la_y3()
...
```{r}
# Alabama
source("year4/AL/code/clean-AL.R")
al_clean_y4<- clean_al_y4()

# Tennessee
source("year4/TN/code/clean-TN.R")
tn_clean_y4 <- clean_tn_y4()
```

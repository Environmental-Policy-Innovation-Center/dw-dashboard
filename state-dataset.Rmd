...
lsl_projects <- all_projects |>
  ...
  data.frame(
   stringsAsFactors = FALSE,
          borrower = c("Pittsburgh Water & Sewer Authority","Pittsburgh Water & Sewer A.", "Lehigh County Authority","City Of Philadelphia"),
          project_id = c("80214","No Information", "No Information","No Information"),
    ...
    dplyr::mutate(
      lead_type_new = coalesce(lead_type_new_TX, lead_type_new_PA),
      lead_type = if_else(lead_type == "both" & !is.na(lead_type_new), 
                              lead_type_new, 
                              lead_type)) |>
    dplyr::select(-c(lead_type_new, lead_type_new_TX, lead_type_new_PA))

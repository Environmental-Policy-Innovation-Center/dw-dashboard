...
- Need to check for requested_amount columns though.
...
- Do we need to bring in requested amount for projects that got funding? Probably? New column across the board?
...
```{r}
de_fund <- fread("data/srf-ppl/8-Delaware_PPL.csv",
                      colClasses = "character", na.strings = "")
...
# (38,13) -> (38,10)
tx_fnd <- fread("data/srf-ppl/43-Texas_Fundable_K.csv",
               colClasses= "character", na.strings="") %>% 
  clean_names() %>%

clean_wi_y3 <- function() {
  ...
  wi_not_fundable <- fread("year3/WI/data/wi-sfy25-not-fundable-list.csv",
                           colClasses = "character", na.strings = "") |>
    janitor::clean_names() |>
    dplyr::mutate(list = "SFY25 Not Fundable List",
  ...
  wi_gen_ec_fundable <- fread("year3/WI/data/wi-sfy25-general-fundable-list.csv",
                            colClasses = "character", na.strings = "") |>
    janitor::clean_names() |>
    dplyr::mutate(list = "SFY25 General Fundable List",
  ...
  wi_lsl_fundable <- fread("year3/WI/data/wi-sfy25-lsl-fundable-list.csv",
    ...
    dplyr::select(project_id, community_served, project_score, project_type, requested_amount, funding_amount, principal_forgiveness, disadvantaged, expecting_funding, list)
